...
There are four quadrants: Deliver, Test, Observe, and Recover. The idea is to balance your engineering efforts across each. If you can't catch a bug before release, catch it after. If you can't catch it at all, recover from it.

I developed the framework in 2021. The team I was leading at the time was struggling — delivery times were escalating, our end-to-end tests were flaky, and we shipped disastrous big-bang deployments every three weeks. We were building a managed distributed system, but I observed that we weren't leveraging the properties of a distributed system to our advantage. Everything needed to change.

![The four quadrants of the Square of Balance: Test, Observe, Recover, Deliver](../../assets/square-of-balance.png)
...
Instead of an expensive, complex and flaky integration test, consider optimising the integration for recovery and observability.
